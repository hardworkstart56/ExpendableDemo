package com.example.tatastrive.expendabledemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    List<String> listDataHeader;    //collection of string TYPE NAMED AS Listdataadapter
    HashMap<String, List<String>> listDataChild;  //hashmap is used to sub header.hashmap take track of child parent or key value pattern.
                                                   // main header is key n sub name is value of that key
    ...
    private void prepareListData() {
        listDataHeader = new ArrayList<>(); //we already pass String value in arrayList
